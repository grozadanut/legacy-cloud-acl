...
public class NameChangeRouteTest extends CamelTestSupport {

    @EndpointInject("mock:listenForComplete")
    private MockEndpoint mock;
    
    @InjectMocks private NameChangeRoute route;
    ...
    protected void doPostSetup() throws Exception {
    	...
    	AdviceWith.adviceWith(context, NameChangeRoute.ID,
    			a -> 
    	{
    ...
    void whenSendBody_thenPostReceivedSuccessfully() throws InterruptedException {
    	...
    	mock.expectedBodiesReceived(gson.toJson(new ChangeNameCommand(1, 100, "59", "ciment holcim")));
