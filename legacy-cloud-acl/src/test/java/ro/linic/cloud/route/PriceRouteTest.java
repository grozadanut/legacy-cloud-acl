...
public class PriceRouteTest extends CamelTestSupport {
    ...
    @InjectMocks private PriceRoute route;
    ...
    protected void doPostSetup() throws Exception {
    	...
    	AdviceWith.adviceWith(context, PriceRoute.ID,
    			a -> 
    	{
    ...
    void whenSendBody_thenPostReceivedSuccessfully() throws InterruptedException {
    	...
    	mock.expectedBodiesReceived(gson.toJson(new ChangePriceCommand(1, 100, new BigDecimal("29.5"))));
