...
public class ProductDeleteRouteTest extends CamelTestSupport {

    @EndpointInject("mock:listenForComplete")
    private MockEndpoint mock;
    
    @InjectMocks private ProductDeleteRoute route;
    ...
    protected void doPostSetup() throws Exception {
    	...
    	AdviceWith.adviceWith(context, ProductDeleteRoute.ID,
    			a -> 
    	{
    ...
    void whenSendBody_thenPostReceivedSuccessfully() throws InterruptedException {
    	...
    	mock.expectedBodiesReceived(gson.toJson(new DeleteProductCommand(1, 100)));
